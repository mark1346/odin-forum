...
class UserUpdateSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        # e.g if admin 'odin' is updating a user 'user123',
        # currentPassword must be 'odin' password instead of 'user123' password
        try:
...
class UserCreateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        avatar = profile_data.get('') or None
        if not avatar:
            # avatar = 'https://api.adorable.io/avatar/200/' + username
            avatar = 'https://adorable-avatars.broken.services/myseed'
